//
//  UpcomingTableController.swift
//  MTimes
//
//  Created by Dee on 3/05/2016.
...
class UpcomingTableController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl?.addTarget(self, action: #selector(UpcomingTableController.refresh(_:)), for: UIControlEvents.valueChanged)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        self.infoLabel.text = " Here Are " + String(currentMovie.count) + " Upcoming Movies"
        if (m.title != nil) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: "U_ViewMovieSegue", sender: nil)
    }
